...
@app.route('/python/', strict_slashes=False)
def Pythonis_cool_route():
    return "Python is cool"

@app.route('/number/89', strict_slashes=False)
def number89_route():
    return "89 is a number"

@app.route('/number/8.9', strict_slashes=False)
def number_89_route():
    return render_template('c')

@app.route('/number/python', strict_slashes=False)
def number_python_route():
    return render_template('c')

@app.route('/number/<n>', strict_slashes=False)
def n_is_a_number_route():
